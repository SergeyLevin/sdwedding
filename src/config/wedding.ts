...
export const WEDDING_CONFIG = {
  ...
  dressCode: {
    title: "Дресс-код",
    description: "Будем рады, если вы поддержите цветовую гамму нашего вечера. Материал и фасон могут быть любыми - выбирайте то, в чём вам комфортно.",
    colors: [
      { name: "Молочный", hex: "#F4EEE7" },
      { name: "Бежевый", hex: "#D8CFC6" },
      { name: "Золотистый", hex: "#C6A77A" },
      { name: "Розовый", hex: "#E8C6CF" },
      { name: "Коричневый", hex: "#5A4338" },
    ],
    menDescription: "светлый верх, тёмный низ. Если есть костюм - отлично, если нет - подойдёт рубашка или водолазка и тёмные брюки. Желательно чёрный, тёмно-синий и коричневый цвета.",
  },
  contacts: {
    host: {
      name: "Артур",
